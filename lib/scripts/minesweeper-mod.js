...
export class Board{
    ...
    getHeight(){
        ...
        if(this.domElement.parentElement.nodeName === 'BODY'){
            height = docViewProperties.screenHeight;
        }else{
            height = this.domElement.parentElement.clientHeight;
        }
    ...
    initBoardScale(){
        if(this.width/50 < Math.sqrt(this.mode.difficultyRank)){
            warningLog("Game difficulty is higher than it allows the board size. The game difficulty will be automatically downgraded.");
            
            this.mode.difficultyRank = Math.round(this.width/50) * Math.round(this.height/50);
        }
...
class GameMode{
    ...
    getEasyMode(){
        let difficultyRank = getRandomRangeInt(80, 100);
...
class ConfigFile{
    ...
    async getRelPath(){
        let result = '.';
        const configURL = this.root + '/minesweeper-config.json';
...
cellColors.set('Darkgray', {r: 129, g: 126, b: 126});
cellColors.set('Gray', {r: 176, g: 176, b: 176});
cellColors.set('Orange', {r: 217, g: 147, b: 104});
cellColors.set('Darkred', {r: 189, g: 127, b: 127});
cellColors.set('Red', {r: 240, g: 163, b: 163});
cellColors.set('Darkgreen', {r: 0, g: 58, b: 108});
cellColors.set('Green', {r: 119, g: 182, b: 148});
cellColors.set('Blue-green', {r: 66, g: 128, b: 114});
cellColors.set('Violet', {r: 196, g: 158, b: 234});
cellColors.set('Darkviolet', {r: 148, g: 124, b: 171});
